...
using DXApplication3.Main.Properties;
using DXApplication3.Main.ViewModels;
using DXApplication3.Main.Views;
using DXApplication3.Modules.ViewModels;
using DXApplication3.Modules.Views;
using System.ComponentModel;
using System.Windows;
using AppModules = DXApplication3.Common.Modules;

namespace DXApplication3.Main
{
